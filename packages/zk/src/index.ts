...
import erc20BalanceCircuit from '../circuits/erc20-balance/target/0.1.1/main.json'
import erc20BalanceVkey from '../circuits/erc20-balance/target/0.1.1/vkey.json'
